...
plugins=(brew docker docker-machine osx make git git-auto-fetch git-shadowstar svn mercurial colored-man-pages themes web-search zsh_reload z zsh-prompt-benchmark)
