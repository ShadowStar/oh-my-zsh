...
plugins=(brew docker docker-machine osx make git git-auto-fetch git-shadowstar svn mercurial colored-man-pages themes web-search z zsh-prompt-benchmark fzf)
