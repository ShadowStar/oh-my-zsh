...
plugins=(brew docker docker-machine macos make git git-auto-fetch git-auto-push git-shadowstar svn mercurial colored-man-pages themes web-search z zsh-prompt-benchmark fzf)
